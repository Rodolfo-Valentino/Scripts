...
sudo pacman -S kwalletmanager kdeplasma-addons spectacle dolphin konsole gwenview kate okular vlc qbittorrent ark unrar p7zip unarchiver partitionmanager plasma-systemmonitor kcalc kde-gtk-config breeze-gtk plasma-framework5 kinfocenter grub-customizer firefox firefox-i18n-es-ar kdenlive obs-studio libreoffice-fresh-es hunspell-es_ar telegram-desktop audacious gimp --noconfirm
